...
class AdminTransportFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_admin_transport, container, false)
        recyclerView = view.findViewById(R.id.recyclerviewAdminTransportBooking)
        getRequest()
        return view
    }
                ...
                if (response.isSuccessful && response.body() != null) {
                    withContext(Dispatchers.Main) {
                        ...
                        if (transportBookings != null) {
                            ...
                            withContext(Dispatchers.Main) {
                                myAdapter = AdminBookingTransportAdapter(mList)
