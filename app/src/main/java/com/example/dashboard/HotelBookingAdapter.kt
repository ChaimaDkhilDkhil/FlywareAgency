...
class HotelBookingAdapter (var mList: ArrayList<HotelBooking>) : RecyclerView.Adapter<HotelBookingAdapter.bookingViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): bookingViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.hotel_booking_list_layout, parent, false)
