...
class AdminFlightFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_admin_flight, container, false)
                ...
                for (i in 0 until response.length()) {
                    ...
                    val userRequest = JsonObjectRequest(
                        ...
                        { userResponse ->
                            ...
                            val flightRequest = JsonObjectRequest(
                                Request.Method.GET, flightUrl, null,
                                { flightResponse ->
                                    ...
                                    myAdapter = AdminBookingFlightAdapter(mList, requestQueue)
