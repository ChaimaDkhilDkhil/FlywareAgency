...
class AdminHotelFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_admin_hotel, container, false)
        recyclerView = view.findViewById(R.id.recyclerviewAdminHotelBooking)
        getRequest()
        return view
    }
            ...
            if (response.isSuccessful && response.body() != null){
                withContext(Dispatchers.Main) {
                    ...
                    if (hotelBookings != null) {
                        ...
                        myAdapter = AdminBookingHotelAdapter(mList)
